...
خاصیت‌های `head` و `body` نیز می‌باشد که به آن عناصر اشاره  می‌کنند.
...
موقعیت اسکرول فعلی را به آن اضافه کنید. این موقعیت را می‌توان در متغیرهای
...
این برنامه را به صورتی بنویسید که در آن ستون‌ها به طور خودکار از اشیاء گرفته می‌شوند و
