...
`if` بایستی فقط بعد از یکی از آرگومان‌های دوم یا سوم بسته به مقدار آرگومان اول
ارزیابی شود.
...
به این گونه زبانها، معمولا _((زبانی با دامنه‌ی خاص))_ گفته می شود؛ زبانی که برای
